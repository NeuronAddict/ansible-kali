...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "shared_kali", "/home/" + vagrant_config['default_user'] + "/shared", create: true, group: vagrant_config['default_user'], owner: vagrant_config['default_user']
